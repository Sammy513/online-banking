...
var config_2 = __importDefault(__webpack_require__(/*! ./config */ "./src/config.ts"));

__webpack_require__(/*! core-js */ "./node_modules/core-js/index.js"); // --------------------


var signInName = document.getElementById('sing-in-name');
...
function signIn(e) {
  e.preventDefault();
  var response = axios_1["default"].get(config_2["default"]).then(function (response) {
  ...
  response.then(function (response) {
    return response.map(function (_a) {
      ...
      if (config_1.regexName.test(signInName.value) && config_1.regexPass.test(signInPass.value)) {
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/sign-in.ts");
/******/ 	
/******/ })()
;
