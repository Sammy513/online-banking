...
var config_2 = __importDefault(__webpack_require__(/*! ./config */ "./src/config.ts")); // DOM -----------------


var valName = document.getElementById('val-name');
var valSurname = document.getElementById('val-surname');
var valEm = document.getElementById('val-em');
var valPass = document.getElementById('val-pass');
...
var signUp = function signUp(e) {
  ...
  if (config_1.regexName.test(valName.value) && config_1.regexSurname.test(valSurname.value) && config_1.regexPass.test(valPass.value) && config_1.regexEm.test(valEm.value)) {
    axios_1["default"].post(config_2["default"], {
      name: valName.value,
      surname: valSurname.value,
      email: valEm.value,
      password: valPass.value,
      registeredIn: Date.now(),
      deposit: '0',
      drawn: '0'
    });
  } else {
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/sign-up.ts");
/******/ 	
/******/ })()
;
