...
var urlObj = new URLSearchParams(url).get("id");
var profileDescription = document.querySelector('.profile-decription');
var deposited = document.querySelector('.deposited-value');
var drawn = document.querySelector('.drawn-value');
var total = document.querySelector('.total-value');
var containerBalances = document.querySelector('.container-balances');
var btnNewTransition = document.querySelector('.btn-newTransition');

var render = function render(data) {
  var _a, _b, _c, _d;

  var name = "" + ((_a = data.find(function (dataId) {
    return dataId.id.toString() === urlObj;
  })) === null || _a === void 0 ? void 0 : _a.name);
  var surname = "" + ((_b = data.find(function (dataId) {
    return dataId.id.toString() === urlObj;
  })) === null || _b === void 0 ? void 0 : _b.surname);
  var depositedValue = "" + ((_c = data.find(function (dataId) {
    return dataId.id.toString() === urlObj;
  })) === null || _c === void 0 ? void 0 : _c.deposit);
  var drawnValue = "" + ((_d = data.find(function (dataId) {
    return dataId.id.toString() === urlObj;
  })) === null || _d === void 0 ? void 0 : _d.drawn);

  if (parseInt(drawnValue) > parseInt(depositedValue)) {}

  var totalValue = parseInt(depositedValue) - parseInt(drawnValue);
...
axios_1["default"].get(config_1["default"]).then(function (response) {
...
function newTransition() {
  ...
  btnDeposit.onclick = function () {
    axios_1["default"].patch(config_1["default"] + "/" + urlObj, {
      deposit: val.value.replace(".", ''),
      drawn: '0'
    }).then(function (data) {
      return data;
    });
...
exports.regexPass = exports.regexEm = exports.regexSurname = exports.regexName = void 0;
var regexName = /^[A-Za-z]{3,7}$/;
exports.regexName = regexName;
var regexPass = /^[0-9\w\.,-@#$%]{6,10}$/;
exports.regexPass = regexPass;
var regexEm = /^[\w.-]+@[\w.-]+\.[\w]{2,}$/;
exports.regexEm = regexEm;
var regexSurname = /^[A-Za-z]{3,9}$/;
exports.regexSurname = regexSurname;
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/banking.ts");
/******/ 	
/******/ })()
;
